...
export const updateCart = (state) => {
  ...
  if (state.shippingAddress && state.shippingAddress.city) {
    const city = state.shippingAddress.city.toLowerCase(); // Check city in lowercase
    ...
    // Default shipping price if city is undefined
